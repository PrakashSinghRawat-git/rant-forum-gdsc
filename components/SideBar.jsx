...
export default function SideBar() {
    ...
    const [isCreateRant, setIsCreateRant] = useState(false);
    ...
    return (
        <div
            ...
            } sidebar z-10  absolute md:black h-[100vh] mr-5`}
        >
            {/* <div className="rounded-r bg-gray-900 xl:hidden flex justify-between w-full py-6 items-center ">
            ...
            {isCreateRant && (
                <CreateRantForm
                    isCreateRant={isCreateRant}
                    setIsCreateRant={setIsCreateRant}
                />
            )}
        </div>
    );
