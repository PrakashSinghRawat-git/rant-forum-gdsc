    ...
    return (
        <>
            <div className="w-full flex-col items-center justify-center   pt-2 px-6 ">
                <form className=" lg:w-[57vw]  mx-auto">
                    ...
                    <div className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                        <div className="flex-col">
                            <button
                                type="button"
                                className="inline-flex justify-center py-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
                            >
                                <svg
                                    className="w-5 h-5"
                                    aria-hidden="true"
                            ...
                            <button
                                type="button"
                                className="py-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
                            >
                                <svg
                                    className="w-5 h-5"
                                    aria-hidden="true"
